...
This folder contains generated figures from the workflow and also figure used in the documentation and notebooks in HTML format.  

## Folder structure
```
├── README.md        <- README file for reports folder
│
├── figures          <- All figures generated from workflow and diagram
